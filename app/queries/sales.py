# номер мероприятия, дата и время продажи, дата посещения, время посещения, количество билетов ...
# ... и тип цены продажи билетов по идентификатору
def by_id(sale_id):
...
# идентификатор, дата и время продажи, дата посещения, время посещения, ...
# ... количество билетов и тип цены продажи билетов по номеру мероприятия
...
# идентификатор, номер мероприятия, дата посещения, время посещения, количество билетов и тип цены продажи билетов, ...
# ... которые принадлежат временному периоду
# формат: '2021-10-14'
def by_period(dates):
...
# идентификатор, номер мероприятия, дата и время продажи, дата посещения, время посещения, ...
# ... количество билетов продажи билетов по типу цены
